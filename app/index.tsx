      ...
      >
        <View className="flex flex-row justify-between items-center ">
          <View className="flex flex-row gap-4  items-center">
            <Text>icon</Text>
            <Text className="font-bold text-2xl ">Daily {'\n'} Diet</Text>
          </View>

          <View className="bg-black w-12 h-12 rounded-full"></View>
        </View>

        <View className="flex items-center justify-center bg-green-200 py-6 rounded-xl relative">
          <Text className="text-center text-4xl font-bold">90,86% {'\n'}
            <Text className="text-xl font-light">das refeições dentro da dieta</Text>
          </Text>

          <MaterialCommunityIcons name="arrow-top-right" size={24} color="green" className="absolute right-6 top-2" />

        </View>

        <View className="mt-10 flex flex-col gap-4 items-start">
          <Text className="text-xl">Refeições</Text>
          <TouchableOpacity className="bg-zinc-800 w-full h-16 rounded-xl flex flex-row items-center justify-center gap-6">
        ...
        <View className="flex justify-center items-start mt-10 gap-4">
          ...
          />
          <DietCard hour={'12:00'} name={"Pizza"} styleCicle={"bg-red-200"} />
        </View>
